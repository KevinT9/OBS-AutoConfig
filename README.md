...
- 🗂️ **Selector de perfil de OBS**: elige a qué perfil leer/aplicar la configuración (antes usaba siempre el primero).
...
2. (Opcional) Elige el **Perfil de OBS** en el desplegable si tienes varios.
3. Pulsa **▶ ANALIZAR Y CONFIGURAR**. Verás tus specs, la configuración recomendada y qué mejorar.
...
- **Servidor de ingest**: elige *Auto* (recomendado) o un servidor concreto de la lista oficial de Twitch. El botón **🔎 Medir latencia** prueba todos los servidores y selecciona el más rápido.
